...
const StudentForm: React.FC<StudentFormProps> = ({ isEdit = false }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      {/* Hanya tombol preview, tombol kembali dihapus */}
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <input type="url" name="mapsUrl" value={formData.mapsUrl} onChange={handleChange} placeholder="Link Google Maps" className="input" />
      ...
      {showPreview && (
        <div className="rounded-xl p-6 mt-6">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-4">
              <div
                className={`inline-block ${STUDENT_CATEGORIES[formData.category].color} text-white px-2 py-1 rounded-full text-xs font-medium mb-3`}
              >
              ...
              {formData.mapsUrl && (
                <div
                  className="w-full my-2 rounded-md overflow-hidden"
                  style={{ height: 200 }}
                >
                  <iframe
